...
export function exportToExcel(columns: any[] = [], rows: any[] = [], filename: string = "republic_insurance_report") {
  if (!rows || !rows.length) {
...
export function exportToPDF(reportTitle: string, columns: any[] = [], rows: any[] = [], summary: Record<string, any> = {}) {
